                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('quantidade_horas', $servico->quantidade_horas ?? '')  }}"  type="input" required class="form-control" name="quantidade_horas" data-mask="0" id="quantidade_horas" placeholder="Quantidade mínima de horas">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('horas_banheiro', $servico->horas_banheiro ?? '')  }}" type="input" required class="form-control" name="horas_banheiro" data-mask="0" id="horas_banheiro" placeholder="Quantidade horas por banheiro">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('horas_cozinha', $servico->horas_cozinha ?? '')  }}" type="input" required class="form-control" name="horas_cozinha" data-mask="0" id="horas_cozinha" placeholder="Quantidade horas por cozinha">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('horas_quintal', $servico->horas_quintal ?? '')  }}" type="input" required class="form-control" name="horas_quintal" data-mask="0" id="horas_quintal"  placeholder="Quantidade horas por quintal">
                            </div>
                        </div>
                    </div>
